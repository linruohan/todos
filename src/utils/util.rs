...
impl Util  {
    ...
    pub fn get_colors (&self) -> HashMap<String,Color>{
        ...
        if self.colors.is_empty() {
            ...
            colors.insert("berry_red", Color::new(30, "Berry Red", "#b8256f");
            colors.insert ("red", new Objects.Color (31, _("Red"), "#db4035"));
            colors.insert ("orange", new Objects.Color (32, _("Orange"), "#ff9933"));
            colors.insert ("yellow", new Objects.Color (33, _("Olive Green"), "#fad000"));
            colors.insert ("olive_green", new Objects.Color (34, _("Yellow"), "#afb83b"));
            colors.insert ("lime_green", new Objects.Color (35, _("Lime Green"), "#7ecc49"));
            colors.insert ("green", new Objects.Color (36, _("Green"), "#299438"));
            colors.insert ("mint_green", new Objects.Color (37, _("Mint Green"), "#6accbc"));
            colors.insert ("teal", new Objects.Color (38, _("Teal"), "#158fad"));
            colors.insert ("sky_blue", new Objects.Color (39, _("Sky Blue"), "#14aaf5"));
            colors.insert ("light_blue", new Objects.Color (40, _("Light Blue"), "#96c3eb"));
            colors.insert ("blue", new Objects.Color (41, _("Blue"), "#4073ff"));
            colors.insert ("grape", new Objects.Color (42, _("Grape"), "#884dff"));
            colors.insert ("violet", new Objects.Color (43, _("Violet"), "#af38eb"));
            colors.insert ("lavender", new Objects.Color (44, _("Lavender"), "#eb96eb"));
            colors.insert ("magenta", new Objects.Color (45, _("Magenta"), "#e05194"));
            colors.insert ("salmon", new Objects.Color (46, _("Salmon"), "#ff8d85"));
            colors.insert ("charcoal", new Objects.Color (47, _("Charcoal"), "#808080"));
            colors.insert ("grey", new Objects.Color (48, _("Grey"), "#b8b8b8"));
            colors.insert ("taupe", new Objects.Color (49, _("Taupe"), "#ccac93"));
        }
...
We hope you’ll enjoy using Planify!""");
    ...
    */
    ...
    pub fn get_reminders_mm_offset (&self) ->i32{
        let  value = Services.Settings.get_default ().settings.get_enum ("automatic-reminders");
        match value {
            0=>0,
            1=>10,
            2=>30,
